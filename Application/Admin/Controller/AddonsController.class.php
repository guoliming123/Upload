...
str;
    ...
    public function build(){
        ...
        if($data['has_outurl']){
            ...
            $files[]    =   "{$addon_dir}Controller/{$data['info']['name']}OrderController.class.php";
...
str;
            file_put_contents("{$addon_dir}Controller/{$data['info']['name']}OrderController.class.php", $addonController);
            $addonModel = <<<str
<?php
