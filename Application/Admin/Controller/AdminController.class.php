...
class AdminController extends Controller {
    ...
    public function getProvince(){
        $addresslist = M('region')->where('fid=0')->select();
        return $addresslist;
    }
    ...
    public function getClass(){
        $where['state'] = 1;
        $classlist = M('classification')->field('id,name cname')->where($where)->order('sort asc')->select();
        return $classlist;
    }
    ...
    public function getCrow(){
        $where['state'] = 1;
        $crowlist = M('crowd')->field('id,name')->where($where)->order('sort asc')->select();
        return $crowlist;
    }
    ...
    public function getSitem(){
        $where['state'] = 1;
        $sitemlist = M('service_items')->field('id,name')->where($where)->order('sort asc')->select();
        return $sitemlist;
    }
}
